...
class ScheduleController extends Controller
{
     ...
     *
     * @Route("/", name="admin_schedule_create")
     * @Method("POST")
     * @Template("AdminBundle:Schedule:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_schedule_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Schedule $entity)
    {
        $form = $this->createForm(new ScheduleType($this->container), $entity, array(
            'action' => $this->generateUrl('admin_schedule_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/new", name="admin_schedule_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_schedule_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Schedule')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="admin_schedule_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_schedule_update")
     * @Method("PUT")
     * @Template("AdminBundle:Schedule:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_schedule_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_schedule_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_schedule_delete', array('id' => $id)))
            ->setMethod('DELETE')
